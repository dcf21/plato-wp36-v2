...
# -*- coding: utf-8 -*-
# task_transit_search_dst_v26.py

"""
Implementation of the EAS pipeline task <transit_search_dst_v26>.
"""

import logging

from plato_wp36 import quality_control, lightcurve, task_database, task_execution
from eas_dst_v26_wrapper import dst_v26
...
def task_handler(execution_attempt: task_database.TaskExecutionAttempt):
    ...
    logging.info("Running <{directory}/{filename}> through DST v26 with duration {lc_days:.1f}.".format(
    ...
    x = dst_v26.process_lightcurve(lc=lc_in, lc_duration=lc_duration, search_settings=search_settings)
