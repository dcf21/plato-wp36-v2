...
(
    ...
    requestedCpus REAL               NOT NULL,
    requestedGpus INTEGER            NOT NULL,
    requestedRam  REAL               NOT NULL,
    assignedCpus  REAL               NOT NULL,
    assignedGpus  INTEGER            NOT NULL,
    assignedRam   REAL               NOT NULL
);
