...
"""
Quality control implementation of the EAS pipeline task <verify>.
"""
...
def task_handler(execution_attempt: task_database.TaskExecutionAttempt):
    """
    Implementation of the QC validation process which happens after the EAS pipeline task <verify>.
