...
def task_handler(execution_attempt: task_database.TaskExecutionAttempt):
    ...
    with task_database.TaskDatabaseConnection() as task_db:
        ...
        lc_specs = execution_attempt.task_object.task_description.get('specs', {})
        filename = execution_attempt.task_object.task_description['outputs']['lightcurve']

        logging.info("Running batman synthesis of <{}>".format(filename))

        # Do synthesis
        with BatmanWrapper() as synthesiser:
