...
from eas_bls_kovacs_wrapper import bls_kovacs
...
def task_handler(execution_attempt: task_database.TaskExecutionAttempt,
    ...
    logging.info("Running <{directory}/{filename}> through BLS Kovacs with duration {lc_days:.1f}.".format(
    ...
    x = bls_kovacs.process_lightcurve(lc=lc_in, lc_duration=lc_duration, search_settings=search_settings)
